...
HD_PWD='C:/Users/Ethan/Desktop/Classes/ECE460M-DigitalSysDesign/Labs/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log input_handler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source input_handler.tcl -notrace
